...
namespace Web.Areas.Customer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(string returnUrl = null)
        {
            ...
            model.Gradovi = _gradoviService.GetGradovi().Select(a =>
                                          new SelectListItem
                                          {
                                              Value = a.Id.ToString(),
                                              Text = a.Naziv
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, PhoneNumber=model.FullPhone };
                ...
                if (result.Succeeded)
                {
                    ...
                    //dodao sam insertkupac servis i ubacio konverter u viewmodel radi vece preglednosti koda
                    _kupacService.InsertKupac(model.convertToKupac(user));
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var mail = new MailRequest
                {
                    ...
                    ToEmail = model.Email,
                    Body = "Resetirajte svoju lozinku tako sto kliknete na ovaj: <a href=\"" + callbackUrl + "\">link</a>"
                };
                await _emailSender.SendEmailAsync(mail);
                return View("ForgotPasswordConfirmation");
            }
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            else if (model.SelectedProvider == "Phone")
            {
                ...
                {
                    Text = message,
                    To = await _userManager.GetPhoneNumberAsync(user)
                };
